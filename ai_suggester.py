...
- Education: Show only top 2 qualifications (latest first) with full degree name, institution, and year(Use exact degree names and university names from the uploaded resume).
